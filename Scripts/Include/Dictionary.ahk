CreateGUITextByLanguage(Language, localVersion) {
    ...
    if (Language = 1) {
        ...
        Lang["languageNotice"] := "切換語言需重啟腳本，是否重啟?"
        Lang["btn_reload"] := "重啟"
        ...
        Lang["Txt_autoUseGPTest"] := "自動使用 GP Test（秒）："
        Lang["Txt_Delay"] := "指令延遲："
        ...
        Lang["Txt_autoLaunchMonitor"] := "啟用監視器"
        ...
        Lang["Txt_spendHourGlass"] := "使用所有沙漏"
        Lang["Txt_openExtraPack"] := "額外多開一包"
        ...
        Lang["Txt_CheckShinyPackOnly"] := "僅在閃光包套用以上設定"
        ...
        Lang["Txt_autoUseGPTest"] := "GP Test自動起動（秒）："
        Lang["Txt_Delay"] := "遅延："
        ...
        Lang["Txt_openExtraPack"] := "追加パックを開く"
        ...
        Lang["Txt_CheckShinyPackOnly"] := "色違いのみ"
        ...
        Lang["Txt_CheckShinyPackOnly"] := "Nur schillernde Booster"
...
CreateSetUpByLanguage(Language) {
    ...
    if (Language = 1) {
        ...
        SetUpLang["Confirm_openExtraPack"] := "• Open Extra Pack"
        SetUpLang["Confirm_SpendHourGlass"] := "• Spend Hourglass"
        ...
        SetUpLang["Confirm_SaveForTrade"] := "Save for Trade"
        SetUpLang["Confirm_Enabled"] := "Enabled"
        SetUpLang["Confirm_Disabled"] := "Disabled"
        SetUpLang["Confirm_SilentPings"] := "Silent Pings"
        ...
        SetUpLang["Confirm_openExtraPack"] := "• 開啟額外卡包"
        ...
        SetUpLang["Confirm_SaveForTrade"] := "啟用保存交換"
        SetUpLang["Confirm_Enabled"] := "已啟用"
        SetUpLang["Confirm_Disabled"] := "已禁用"
        SetUpLang["Confirm_SilentPings"] := "靜音（不通知）"
        SetUpLang["Confirm_Gholdengo"] := "賽富豪"
        ...
        SetUpLang["Confirm_openExtraPack"] := "• 追加パックを開封"
        ...
        SetUpLang["Confirm_SaveForTrade"] := "交換保存を有効化"
        SetUpLang["Confirm_Enabled"] := "有効"
        SetUpLang["Confirm_Disabled"] := "無効"
        SetUpLang["Confirm_SilentPings"] := "通知なし（サイレント）"
        ...
        SetUpLang["Confirm_openExtraPack"] := "• Extra-Pack öffnen"
        ...
        SetUpLang["Confirm_SaveForTrade"] := "Für Tausch speichern aktivieren"
        SetUpLang["Confirm_Enabled"] := "Aktiviert"
        SetUpLang["Confirm_Disabled"] := "Deaktiviert"
        SetUpLang["Confirm_SilentPings"] := "Still (Kein Ping)"
        SetUpLang["Confirm_Gholdengo"] := "Gholdengo"
